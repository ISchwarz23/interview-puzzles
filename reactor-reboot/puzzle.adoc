...
== Problem description
You are the machinist on a submarine which is powered by a futuristic reactor. Unfortunatelly this reactor still has some bugs and needs to be rebooted from time to time. It's your task to perform such an reboot now.
